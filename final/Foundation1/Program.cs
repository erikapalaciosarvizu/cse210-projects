class Program
{
    static void Main()
    {
        Video video1 = new Video("Paramore - The News (Official Video)", "Paramore", 188);
        ...
        Video video2 = new Video("PVRIS - I DON'T WANNA DO THIS ANYMORE (OFFICIAL MUSIC VIDEO)", "PVRIS", 208);
        ...
        Video video3 = new Video("All Time Low: Sleepwalking [OFFICIAL VIDEO]", "All Time Low", 195);
